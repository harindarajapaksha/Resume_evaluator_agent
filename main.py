...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("-r", "--resume", help="Path to the resume.txt file", required=True)
    parser.add_argument("-p", "--position", help="Path to the position_description.txt file", required=True)
